<template>
  <section class="container">
    ...
    <nuxt-link class="button--grey back" v-bind:to="{name: 'articles-id', params: {id: $route.params.id}}">Cancel</nuxt-link>
  </section>
</template>
  ...
  methods: {
    ...
    async update () {
      ...
      if (res.data.id !== undefined) {
        this.$router.push({name: 'articles-id', params: {id: res.data.id}})
      }else{
